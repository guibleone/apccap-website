...
function Navbar() {
  ...
  return (
    <Box>
      ...
      {user && (user.role === 'user' || user.role === 'produtor') && (
        <>
          <Box sx={{
            ...
            <h4 style={{ color: '#FAF8F8', fontWeight: 500 }}>
              Você está logado como <span style={{ color: '#FAF8F8', fontWeight: 600 }}>{user.role === 'user' ? 'produtor' : user.role}</span>
            </h4>
          </Box>
          ...
          <Box>
            <div className="navbar">
              ...
              <div className="links-centrais">
                ...
                <Link className="links" to="/selos"><h4>Selos</h4></Link>
                <Link className="links" to="/credencial"><h4>Dados e credencial</h4></Link>
                  ...
                  <Box sx={{
                    ...
                    <Box sx={
                      ...
                      <svg xmlns="http://www.w3.org/2000/svg" width="10" height="5" viewBox="0 0 10 5" fill="none">
                        <path d="M9 0.984375L5.64018 3.78422C5.26934 4.09326 4.73066 4.09326 4.35982 3.78422L1 0.984376" stroke="#0F0A70" stroke-linecap="round" stroke-linejoin="round" />
                      </svg>
                    </Box>
