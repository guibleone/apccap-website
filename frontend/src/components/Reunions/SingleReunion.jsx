...
import { addReunionAta, finishReunion, getOneReunion, presenceList, signAta } from '../../features/reunion/reunionSlice'
import { Link, useParams } from 'react-router-dom'
import { useDropzone } from 'react-dropzone'
import { styleError } from '../../pages/toastStyles'
...
export default function SingleReunion() {
    ...
    const { reunionData, isLoading } = useSelector((state) => state.reunions)
